...
export const useAnalyticsData = (
	...
	const memoizedStats = useMemo(() => {
		...
		const studentsData = students
			...
			.filter((student): student is StudentPerformanceDatum => Boolean(student));
	...
	}, [analyticsData, timeRange, selectedCourseId]);
	...
	return {
		loading,
		error,
		heatmapData: memoizedStats.heatmapData,
		heatmapLabels: memoizedStats.heatmapLabels,
		distributionData: memoizedStats.distributionData,
		totalEvaluations: memoizedStats.totalEvaluations,
		studentsData: memoizedStats.studentsData,
		averageGrade: memoizedStats.averageGrade,
		approvalRate: memoizedStats.approvalRate,
